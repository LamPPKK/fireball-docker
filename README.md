...
- Repeat the already-passing two-tenant and browser-state gates against the immutable candidate digest. The source-revision gates prove process/network/mount/tmpfs/signaling boundaries plus cookie, localStorage, service-worker, and burn/recreate separation.
