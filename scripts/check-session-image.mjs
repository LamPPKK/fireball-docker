...
assert.match(supervisor, /stdio: \["pipe", "inherit", "inherit", "pipe"\]/);
assert.match(supervisor, /controlOutput: runtimeProcess\.stdio\[3\]/);
assert.match(nativeRuntime, /--control-output-fd/);
